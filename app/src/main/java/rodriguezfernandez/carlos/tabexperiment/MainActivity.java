package rodriguezfernandez.carlos.tabexperiment;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Añadimos nuevas tablas y les establecemos el texto.
        ...
        // Instanciamos el viewpager definido en el layout
        final ViewPager viewPager = findViewById(R.id.pager);
        //Instanciamos un PagerAdapter, necesita
        final PagerAdapter adapter = new PagerAdapter
                (getSupportFragmentManager(), tabLayout.getTabCount());
        //Le proporcionamos al ViewPager como adaptador el que acabamos de crear.
